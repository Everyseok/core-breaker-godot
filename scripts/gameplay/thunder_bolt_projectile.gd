extends Area2D
# ThunderBoltProjectile — Tier 2 yellow electric fork.
# Fires in pairs, bounces 3 times, same-layer spread radius 1.
...
func _on_area_entered(area: Area2D) -> void:
	...
	var bounce_normal := Vector2.ZERO
	...
	if area.has_method("resolve_projectile_hit"):
		area.call("resolve_projectile_hit", damage, HIT_SPREAD_RADIUS, VISUAL_TIER)
