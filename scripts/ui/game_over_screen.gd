...
func _on_game_over() -> void:
	...
	_score_label.add_theme_color_override("font_color", Color(0.28, 0.20, 0.28))
	visible = true
...
func _on_max_level_cleared() -> void:
	...
	_score_label.add_theme_color_override("font_color", Color(0.52, 0.34, 0.06))
	visible = true
...
func _apply_style() -> void:
	...
	UiStyleRef.apply_button(_restart_button, UiStyleRef.MENU_PRIMARY_FILL, UiStyleRef.MENU_PRIMARY_BORDER, Color.WHITE, 20)
